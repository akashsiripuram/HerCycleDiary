...
function Dashboard() {
  ...
  const daysUntilNextPeriod = Math.ceil((nextPeriodDate - new Date()) / (1000 * 60 * 60 * 24))
  ...
  const selfCareCards = [
    {
      title: 'Nutrition Tip',
      description: 'Boost iron intake with leafy greens and lean proteins during menstruation.',
      icon: '🥗'
    },
    {
      title: 'Exercise Tip',
      description: 'Light yoga or stretching can help relieve menstrual cramps.',
      icon: '🧘‍♀️'
    },
    {
      title: 'Self-Care',
      description: 'Try a warm compress on your lower abdomen to ease discomfort.',
      icon: '💆‍♀️'
    }
  ]
            ...
            <div className="bg-gradient-to-r from-primary-500/10 to-secondary-500/10 dark:from-primary-900/50 dark:to-secondary-900/50 rounded-xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Next Period in</p>
                  <p className="text-2xl font-bold text-primary-600 dark:text-primary-400">
                    {daysUntilNextPeriod} days
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Cycle Length</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-7 gap-1 text-center">
                {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day, i) => (
                  <div key={i} className="text-gray-500 dark:text-gray-400 text-sm">
                    {day}
                  </div>
                ))}
                {Array.from({ length: 31 }, (_, i) => (
                  <div
                    ...
                    className={`p-2 text-sm rounded-full
                      ${i + 1 === 15 ? 'bg-primary-100 dark:bg-primary-900/50 text-primary-700 dark:text-primary-300' : 
